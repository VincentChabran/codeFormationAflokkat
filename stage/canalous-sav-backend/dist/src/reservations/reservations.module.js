...
const reservations_resolver_1 = require("./reservations.resolver");
...
ReservationsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [reservations_resolver_1.ReservationsResolver, reservations_service_1.ReservationsService],
