...
__decorate([
    ...
    (0, graphql_1.Field)(() => graphql_1.Int),
    __metadata("design:type", Number)
], DatabaseFile.prototype, "reclamationId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => reclamation_entity_1.Reclamation, (reclamation) => reclamation.files, {
        lazy: true,
        onDelete: "CASCADE",
    }),
    (0, graphql_1.Field)(() => reclamation_entity_1.Reclamation),
    __metadata("design:type", Promise)
], DatabaseFile.prototype, "reclamation", void 0);
DatabaseFile = __decorate([
    (0, typeorm_1.Entity)(),
    (0, graphql_1.ObjectType)()
], DatabaseFile);
exports.default = DatabaseFile;
